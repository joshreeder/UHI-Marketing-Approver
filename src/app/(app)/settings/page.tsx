...
import { REMINDER_HOUR_LOCAL } from "@/lib/tz";
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          <section className="rounded-xl border border-line bg-white p-5">
            ...
            <p className="mb-4 text-xs text-slate">New projects start with these. Automatic reminders go out once a day at {REMINDER_HOUR_LOCAL}:00 AM in the time zone below, year-round.</p>
