...
You create a **project**, add the **item** being reviewed (a flyer, a postcard, an email), upload **versions** of it, and send each
...
Team members, planning defaults, reminder toggles, auto-complete, and a read-out of whether email and file storage are configured.
